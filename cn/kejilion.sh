...
if [ "$country" = "CN" ]; then
    cd ~
    curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/docker/main/install && chmod +x install
...
install_ldnmp_conf() {
  ...
  wget -O /home/web/nginx.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/nginx10.conf
  wget -O /home/web/conf.d/default.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/default10.conf

  default_server_ssl

  # 下载 docker-compose.yml 文件并进行替换
  wget -O /home/web/docker-compose.yml https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/docker/main/LNMP-docker-compose-10.yml
...
install_ldnmp() {
      ...
      commands=(
          ...
          # php安装包管理
          "curl -sL https://gh-proxy.com/https://github.com/mlocati/docker-php-extension-installer/releases/latest/download/install-php-extensions -o /usr/local/bin/install-php-extensions > /dev/null 2>&1"
          ...
          "docker exec php sh -c '\
                    ...
                    && rm -rf /tmp/imagick \
                    && git clone https://gh-proxy.com/https://github.com/Imagick/imagick /tmp/imagick \
                    && cd /tmp/imagick \
                    && phpize \
                    && ./configure \
                    && make \
...
install_certbot() {
    ...
    # 下载并使脚本可执行
    curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/auto_cert_renewal.sh
...
reverse_proxy() {
      ip_address
      wget -O /home/web/conf.d/$yuming.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/reverse-proxy.conf
...
cluster_python3() {
    cd ~/cluster/
    curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/python-for-vps/main/cluster/$py_task
...
f2b_install_sshd() {
    ...
    if grep -q 'Alpine' /etc/issue; then
        ...
        curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/config/main/fail2ban/alpine-sshd.conf
        curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/config/main/fail2ban/alpine-sshd-ddos.conf
        cd /path/to/fail2ban/config/fail2ban/jail.d/
        curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/config/main/fail2ban/alpine-ssh.conf
    elif command -v dnf &>/dev/null; then
        cd /path/to/fail2ban/config/fail2ban/jail.d/
        curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/config/main/fail2ban/centos-ssh.conf
    else
        install rsyslog
        systemctl start rsyslog
        systemctl enable rsyslog
        cd /path/to/fail2ban/config/fail2ban/jail.d/
        curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/config/main/fail2ban/linux-ssh.conf
    fi
}
...
dd_xitong() {
        send_stats "重装系统"
        dd_xitong_MollyLau() {
            wget --no-check-certificate -qO InstallNET.sh 'https://gh-proxy.com/https://raw.githubusercontent.com/leitbogioro/Tools/master/Linux_reinstall/InstallNET.sh' && chmod a+x InstallNET.sh
        }
            ...
            while true; do
                  ...
                  case $sub_choice in
                      1)
                        ...
                        wget -qO - https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/archive.key | gpg --dearmor -o /usr/share/keyrings/xanmod-archive-keyring.gpg --yes

                        # 步骤3：添加存储库
                        echo 'deb [signed-by=/usr/share/keyrings/xanmod-archive-keyring.gpg] http://deb.xanmod.org releases main' | tee /etc/apt/sources.list.d/xanmod-release.list

                        # version=$(wget -q https://dl.xanmod.org/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
                        version=$(wget -q https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
...
linux_bbr() {
    ...
    if [ -f "/etc/alpine-release" ]; then
        ...
        install wget
        wget --no-check-certificate -O tcpx.sh https://gh-proxy.com/https://raw.githubusercontent.com/ylx2016/Linux-NetSpeed/master/tcpx.sh
        chmod +x tcpx.sh
        ./tcpx.sh
    fi
    ...
    while true; do
      ...
      case $sub_choice in
          ...
          3)
              ...
              install wget
              wget -qO- https://gh-proxy.com/https://github.com/yeahwu/check/raw/main/check.sh | bash
              ;;
          4)
              clear
          ...
          12)
              ...
              curl https://gh-proxy.com/https://raw.githubusercontent.com/zhucaidan/mtr_trace/main/mtr_trace.sh | bash
              ;;
          13)
              clear
          ...
          16)
              ...
              curl https://gh-proxy.com/https://raw.githubusercontent.com/ludashi2020/backtrace/main/install.sh -sSf | sh
              ;;
      ...
      case $sub_choice in
          ...
          case "$choice" in
            [Yy])
              ...
              install wget
              bash <(wget --no-check-certificate -qO- 'https://gh-proxy.com/https://raw.githubusercontent.com/MoeClub/Note/master/InstallNET.sh') $xitong -v 64 -p $vpspasswd -port 22
...
linux_ldnmp() {
  ...
  while true; do
    ...
    case $sub_choice in
      ...
      wget -O /home/web/conf.d/$yuming.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/wordpress.com.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/discuz.com.conf
      ...
      mkdir $yuming
      cd $yuming
      wget -O latest.zip https://gh-proxy.com/https://github.com/kejilion/Website_source_code/raw/main/Discuz_X3.5_SC_UTF8_20240520.zip
      unzip latest.zip
      rm latest.zip
      ...
      wget -O /home/web/conf.d/$yuming.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/kdy.com.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf

      cd /home/web/html
      mkdir $yuming
      cd $yuming
      wget -O latest.zip https://gh-proxy.com/https://github.com/kalcaddle/kodbox/archive/refs/tags/1.50.02.zip
      unzip -o latest.zip
      rm latest.zip
      ...
      wget -O /home/web/conf.d/$yuming.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/maccms.com.conf
      ...
      mkdir $yuming
      cd $yuming
      # wget https://gh-proxy.com/https://github.com/magicblack/maccms_down/raw/master/maccms10.zip && unzip maccms10.zip && rm maccms10.zip
      wget https://gh-proxy.com/https://github.com/magicblack/maccms_down/raw/master/maccms10.zip && unzip maccms10.zip && mv maccms10-*/* . && rm -r maccms10-* && rm maccms10.zip
      cd /home/web/html/$yuming/template/ && wget https://gh-proxy.com/https://github.com/kejilion/Website_source_code/raw/main/DYXS2.zip && unzip DYXS2.zip && rm /home/web/html/$yuming/template/DYXS2.zip
      cp /home/web/html/$yuming/template/DYXS2/asset/admin/Dyxs2.php /home/web/html/$yuming/application/admin/controller
      cp /home/web/html/$yuming/template/DYXS2/asset/admin/dycms.html /home/web/html/$yuming/application/admin/view/system
      mv /home/web/html/$yuming/admin.php /home/web/html/$yuming/vip.php && wget -O /home/web/html/$yuming/application/extra/maccms.php https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/Website_source_code/main/maccms.php
      ...
      wget -O /home/web/conf.d/$yuming.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/dujiaoka.com.conf
      ...
      mkdir $yuming
      cd $yuming
      wget https://gh-proxy.com/https://github.com/assimon/dujiaoka/releases/download/2.0.6/2.0.6-antibody.tar.gz && tar -zxvf 2.0.6-antibody.tar.gz && rm 2.0.6-antibody.tar.gz
      ...
      wget -O /home/web/conf.d/$yuming.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/flarum.com.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/typecho.com.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf

      cd /home/web/html
      mkdir $yuming
      cd $yuming
      wget -O latest.zip https://gh-proxy.com/https://github.com/typecho/typecho/releases/latest/download/typecho.zip
      unzip latest.zip
      rm latest.zip
      ...
      wget -O /home/web/conf.d/$yuming.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/index_php.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/rewrite.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/reverse-proxy-domain.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/html.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
    ...
    33)
      ...
      cd ~
      wget -O ${useip}_beifen.sh https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/beifen.sh > /dev/null 2>&1
        ...
        if docker inspect fail2ban &>/dev/null ; then
              ...
              case $sub_choice in
                  ...
                  21)
                      ...
                      wget -O /home/web/conf.d/default.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/nginx/main/default11.conf
                      docker restart nginx

                      cd /path/to/fail2ban/config/fail2ban/jail.d/
                      curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/config/main/fail2ban/nginx-docker-cc.conf

                      cd /path/to/fail2ban/config/fail2ban/action.d
                      curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/config/main/fail2ban/cloudflare-docker.conf
                  ...
                  22)
                      ...
                      install jq bc
                      check_crontab_installed
                      curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/CF-Under-Attack.sh
            ...
            f2b_install_sshd
            cd /path/to/fail2ban/config/fail2ban/filter.d
            curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/fail2ban-nginx-cc.conf
            cd /path/to/fail2ban/config/fail2ban/jail.d/
            curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/config/main/fail2ban/nginx-docker-cc.conf
    ...
    36)
          while true; do
              ...
              case $sub_choice in
                  ...
                  # php调优
                  wget -O /home/optimized_php.ini https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/optimized_php.ini
                  docker cp /home/optimized_php.ini php:/usr/local/etc/php/conf.d/optimized_php.ini
                  docker cp /home/optimized_php.ini php74:/usr/local/etc/php/conf.d/optimized_php.ini
                  rm -rf /home/optimized_php.ini

                  # php调优
                  wget -O /home/www.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/www-1.conf
                  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
                  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
                  rm -rf /home/www.conf

                  # mysql调优
                  wget -O /home/custom_mysql_config.cnf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/custom_mysql_config-1.cnf
                  ...
                  # php调优
                  wget -O /home/www.conf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/www.conf
                  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
                  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
                  rm -rf /home/www.conf

                  # mysql调优
                  wget -O /home/custom_mysql_config.cnf https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/custom_mysql_config.cnf
                  docker cp /home/custom_mysql_config.cnf mysql:/etc/mysql/conf.d/
                  rm -rf /home/custom_mysql_config.cnf
    ...
    37)
      ...
      while true; do
          ...
          case $sub_choice in
              ...
              curl -sL https://gh-proxy.com/https://github.com/mlocati/docker-php-extension-installer/releases/latest/download/install-php-extensions -o /usr/local/bin/install-php-extensions
      ...
      case $sub_choice in
          ...
          7)
            ...
            while true; do
                ...
                case $choice in
                    1)
                        curl -L https://gh-proxy.com/https://raw.githubusercontent.com/naiba/nezha/master/script/install.sh  -o nezha.sh && chmod +x nezha.sh
                        ./nezha.sh
                        ;;
                    0)
                        break
          ...
          12)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/whyour/qinglong"
            docker_use=""
            docker_passwd=""
            docker_app
            ...
            while true; do
                ...
                case $choice in
                    1)
                        ...
                        curl -o /home/docker/cloud/docker-compose.yml https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/docker/main/cloudreve-docker-compose.yml
          ...
          14)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/icret/EasyImages2.0"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          16)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/wikihost-opensource/als"
            docker_use=""
            docker_passwd=""
            docker_app
          ...
          21)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/coder/code-server"
            docker_use="sleep 3"
          ...
          22)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/louislam/uptime-kuma"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          23)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/usememos/memos"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          27)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/louislam/dockge"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          28)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/librespeed/speedtest"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          31)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/Stirling-Tools/Stirling-PDF"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          34)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/stonith404/pingvin-share"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          35)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/kingwrcy/moments?tab=readme-ov-file"
          ...
          36)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/lobehub/lobe-chat"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          37)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/jason5ng32/MyIP/blob/main/README_ZH.md"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          39)
            ...
            if [ ! -d /home/docker/bililive-go/ ]; then
                ...
                wget -O /home/docker/bililive-go/config.yml https://gh-proxy.com/https://raw.githubusercontent.com/hr3lxphr6j/bililive-go/master/config.yml > /dev/null 2>&1
            fi
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/hr3lxphr6j/bililive-go"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          40)
            ...
            docker_url="官网介绍: https://gh-proxy.com/https://github.com/dockur/windows"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
          ...
          41)
            ...
            while true; do
                ...
                echo "官方地址: https://gh-proxy.com/https://github.com/TheTNB/panel"
                echo "------------------------"
                echo "1. 安装            2. 管理            3. 卸载"
                echo "------------------------"
                echo "0. 返回上一级"
          ...
          51)
            clear
            send_stats "PVE开小鸡"
            curl -L https://gh-proxy.com/https://raw.githubusercontent.com/oneclickvirt/pve/main/scripts/install_pve.sh -o install_pve.sh && chmod +x install_pve.sh && bash install_pve.sh
              ;;
          0)
              kejilion
              ;;
...
EOF
          ...
          while true; do
            if docker inspect fail2ban &>/dev/null ; then
              ...
              echo "官网介绍: https://gh-proxy.com/https://github.com/fail2ban/fail2ban"
              echo "------------------------------------------------"
            ...
            while true; do
                ...
                case "$Limiting" in
                  1)
                    ...
                    cd ~
                    curl -Ss -o ~/Limiting_Shut_down.sh https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/Limiting_Shut_down1.sh
              ...
              case "$choice" in
                [Yy])
                  ...
                  if [ -f ~/TG-check-notify.sh ]; then
                      ...
                      curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/TG-check-notify.sh
                      chmod +x ~/TG-check-notify.sh
                      nano ~/TG-check-notify.sh
                  fi
                  ...
                  curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/TG-SSH-check-notify.sh > /dev/null 2>&1
          ...
          26)
              ...
              cd ~
              curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/upgrade_openssh9.8p1.sh
...
kejilion_update() {
    ...
    echo "更新日志"
    echo "------------------------"
    echo "全部日志: https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/kejilion_sh_log.txt"
    echo "------------------------"

    curl -s https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/kejilion_sh_log.txt | tail -n 35
    sh_v_new=$(curl -s https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/kejilion.sh | grep -o 'sh_v="[0-9.]*"' | cut -d '"' -f 2)
    ...
    if [ "$sh_v" = "$sh_v_new" ]; then
        ...
        case "$choice" in
            [Yy])
                ...
                country=$(curl -s ipinfo.io/country)
                if [ "$country" = "CN" ]; then
                    curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/cn/kejilion.sh && chmod +x kejilion.sh
                else
                    curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/kejilion.sh && chmod +x kejilion.sh
                fi
                CheckFirstRun_true
                yinsiyuanquan2
                cp -f ./kejilion.sh /usr/local/bin/k > /dev/null 2>&1
...
case $choice in
  ...
  p)
    send_stats "幻兽帕鲁开服脚本"
    cd ~
    curl -sS -O https://gh-proxy.com/https://raw.githubusercontent.com/kejilion/sh/main/palworld.sh && chmod +x palworld.sh && ./palworld.sh
    exit
    ;;
