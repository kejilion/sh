...
PY
	...
	openclaw_api_providers_showcase() {
		...
		echo ""
		echo -e "  ${gl_huang}● 白山云${gl_bai} ${gl_zi}[AFF]${gl_bai}"
		echo -e "    ${gl_kjlan}https://ai.baishan.com/auth/login?referralCode=6crtUISIWd${gl_bai}"
		echo -e "    ${gl_kjlan}&utm_source=kejilion&utm_medium=blog&utm_campaign=baishan-150-coupon-202603${gl_bai}"
		echo ""
