...
EOF
  ...
  while true; do
    ...
    case $sub_choice in
      ...
      wget -O /home/web/docker-compose.yml https://raw.githubusercontent.com/kejilion/docker/main/LNMP-docker-compose-11.yml
    ...
    37)
      ...
      docker rmi nginx nginx:alpine php:fpm php:fpm-alpine php:7.4.33-fpm php:7.4-fpm-alpine mysql redis redis:alpine wordpress:php-fpm-alpine wordpress:php7.4-fpm-alpine
