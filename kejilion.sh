...
echo -e "服务器优惠"
echo "------------------------"
echo -e "${gl_kjlan}RackNerd 10.18刀每年 美国 1核心 768M内存 15G硬盘 1T流量每月${gl_bai}"
...
echo "------------------------"
echo -e "${gl_kjlan}DMIT 28刀每季 美国CN2GIA 1核心 2G内存 20G硬盘 800G流量每月${gl_bai}"
...
echo -e "域名优惠"
echo "------------------------"
echo -e "${gl_kjlan}GNAME 8.8刀首年COM域名 6.68刀首年CC域名${gl_bai}"
