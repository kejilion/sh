...
ldnmp_wp() {
  ...
  unzip latest.zip
  rm latest.zip
  echo "define('FS_METHOD', 'direct'); define('WP_REDIS_HOST', 'redis'); define('WP_REDIS_PORT', '6379'); define('WP_REDIS_MAXTTL', 86400);" >> /home/web/html/$yuming/wordpress/wp-config-sample.php
