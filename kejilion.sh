...
linux_work() {
    ...
    while true; do
      ...
      echo -e "${gl_lv}------------------------"
      echo -e "${gl_lv}1.   ${gl_bai}1号工作区"
      echo -e "${gl_lv}2.   ${gl_bai}2号工作区"
      echo -e "${gl_lv}3.   ${gl_bai}3号工作区"
      echo -e "${gl_lv}4.   ${gl_bai}4号工作区"
      echo -e "${gl_lv}5.   ${gl_bai}5号工作区"
      echo -e "${gl_lv}6.   ${gl_bai}6号工作区"
      echo -e "${gl_lv}7.   ${gl_bai}7号工作区"
      echo -e "${gl_lv}8.   ${gl_bai}8号工作区"
      echo -e "${gl_lv}9.   ${gl_bai}9号工作区"
      echo -e "${gl_lv}10.  ${gl_bai}10号工作区"
      echo -e "${gl_lv}------------------------"
      echo -e "${gl_lv}99.  ${gl_bai}工作区管理 ${gl_huang}★${gl_bai}"
      echo -e "${gl_lv}------------------------"
      echo -e "${gl_lv}0.   ${gl_bai}返回主菜单"
      echo -e "${gl_lv}------------------------${gl_bai}"
      read -p "请输入你的选择: " sub_choice
